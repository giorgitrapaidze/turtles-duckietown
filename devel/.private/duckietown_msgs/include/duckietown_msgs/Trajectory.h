  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::duckietown_msgs::Trajectory_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.pos.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.pos[i]);
    }
    if (v.pos.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.vel.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.vel[i]);
    }
    if (v.vel.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.acc.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.acc[i]);
    }
    if (v.acc.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.jerk.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.jerk[i]);
    }
    if (v.jerk.empty() || false)
      s << "]";
  }
